...
@section('content')
    <div class="flex justify-center">
        <div class="w-6/12 bg-white p-10 rounded-lg">
            ...
            <h2 class="text-4xl text-blue-900 mb-4 font-bold">

                {{-- Enter Record --}}
                @lang('public.Enter Record')
            ...
            <form action="{{ route('posts') }}" method="post" enctype="multipart/form-data" class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="hidden" name="name" id="name" placeholder=""
                        class="br-gray-100 border-2 w-full p-2 rounded-lg" value="{{ auth()->user()->name }}">
                </div>
          ...
          @enderror
                ...
                <div class="mb-4">
                    <label for="bill" class="sr-only">

                        {{-- Fuel Cost --}}
                        @lang('public.Fuel Cost')
                ...
                <div class="mb-4">
                    <label for="damageImage" class="sr-only">

                        {{-- Damage Image --}}
                        @lang('public.Damage Image')
          ...
          @enderror
                ...
                <div>
                    <button type="submit" class="bg-blue-900 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded">
