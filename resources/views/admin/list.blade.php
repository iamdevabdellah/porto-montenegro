    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col w-full mb-12 text-left lg:text-center">
                ...
                <h1 class="mb-6 text-2xl font-black tracking-tighter text-blue-900 sm:text-5xl title-font"> Porto Montenegro
                    <br class="md:hidden">Records
                </h1>
                <p class="mx-auto text-base font-medium leading-relaxed text-blueGray-700 lg:w-2/3">

                    {{-- Record Listing --}}
                    @lang('public.Record Listing')
