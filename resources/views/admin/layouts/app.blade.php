...
<body class="bg-white-50">
    ...
    <nav class="bg-gray-100">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    @guest
                        ...
                        <a href="{{ route('register') }}"
                            class="py-2 px-3 bg-blue-900 hover:bg-blue-700 text-white transition duration-300">
                            {{-- Signup --}}
                            @lang('public.Signup')
                        </a>
                    @endguest
        ...
        <div class="mobile-menu hidden md:hidden">
            ...
            @auth
                <a href="{{ route('admin.dashboard') }}" class="block py-2 px-4 text-sm hover:bg-gray-200 text-center">
                    {{-- Dashboard --}}
                    @lang('public.Dashboard')
                </a>
                <a href="{{ route('admin.lists') }}" class="block py-2 px-4 text-sm hover:bg-gray-200 text-center">
                    {{-- Lists --}}
                    @lang('public.Lists')

                </a>
                <a href="{{ route('admin.search') }}" class="block py-2 px-4 text-sm hover:bg-gray-200 text-center">
                    {{-- Search --}}
                    @lang('public.Search')
                </a>
            @endauth
